(function(){
  ...
  const SCRIPT_URL="vendor/mespeak/mespeak.js?v=184";
  const CONFIG_URL="vendor/mespeak/mespeak_config.json?v=184";
  const VOICE_URL="vendor/mespeak/voices/fr.json?v=184";
  ...
  function status(){
    return {version:"mespeak-v184",ready,loading:!!loading,currentId,last:{...last}};
  }

  window.LibcomlairFallbackVoice=Object.freeze({
    version:"mespeak-v184",
    prepare,
    speak,
    stop,
    status
