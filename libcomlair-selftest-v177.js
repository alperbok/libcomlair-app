(function(){
  ...
  function run(){
    const checks=[
      check("Voix",!!(window.LibcomlairVoice&&window.LibcomlairVoice.version==="v177"&&typeof window.LibcomlairVoice.speak==="function"&&typeof window.LibcomlairVoice.testDetailed==="function"),"moteur vocal Samsung hybride"),
