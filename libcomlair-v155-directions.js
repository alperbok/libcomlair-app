...
const STATIC_VERSION="155";
const staticShardCache=new Map();
const CACHE_KEY="libcomlair-idfm-directions-v153";
...
function renderLines(box,lines,cached){
  ...
  source.textContent=(cached?"Directions enregistrées récemment. ":"")+"Source : données officielles GTFS d’Île-de-France Mobilités, indexées automatiquement.";
