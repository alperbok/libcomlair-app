(function(){
  ...
  const SCRIPT_URL="https://cdn.jsdelivr.net/gh/btopro/mespeak@master/mespeak.js";
  ...
  function status(){
    return {version:"mespeak-v181",ready,loading:!!loading,currentId,last:{...last}};
  }

  window.LibcomlairFallbackVoice=Object.freeze({
    version:"mespeak-v181",
    prepare,
    speak,
    stop,
    status
