(function(){
  ...
  function run(){
    ...
    const checks=[
      check("Voix",!!(voiceEngine&&voiceEngine.version==="v184"&&typeof voiceEngine.speak==="function"&&typeof voiceEngine.testDetailed==="function"&&!voiceHadFailure),voiceMode),
    ...
    const result={ok:failed.length===0&&runtimeErrors.length===0,checks,failed,runtimeErrors:[...runtimeErrors],version:"v184"};
