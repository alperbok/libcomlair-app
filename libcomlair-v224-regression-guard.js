(()=>{
  ...
  function snapshot(){
    const checks=[
      {name:"Routeur micro contextuel",ok:!!(window.LibcomlairVoiceRouter&&window.LibcomlairVoiceRouter.version==="v224-4"&&typeof window.LibcomlairVoiceRouter.start==="function")},
    ...
    return {ok:checks.every(x=>x.ok),checks,version:"v224-5"};
  }
  ...
  window.LibcomlairRegressionGuard=Object.freeze({version:"v224-5",run:appendToDiagnostic,snapshot});
})();