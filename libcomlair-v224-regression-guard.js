(()=>{
  ...
  function snapshot(){
    const checks=[
      {name:"Routeur micro contextuel",ok:!!(window.LibcomlairVoiceRouter&&window.LibcomlairVoiceRouter.version==="v224-3"&&typeof window.LibcomlairVoiceRouter.start==="function")},
    ...
    return {ok:checks.every(x=>x.ok),checks,version:"v224-4"};
  }
  ...
  window.LibcomlairRegressionGuard=Object.freeze({version:"v224-4",run:appendToDiagnostic,snapshot});
})();