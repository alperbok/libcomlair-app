(function(){
  ...
  function run(){
    const checks=[
      check("Voix",!!(window.LibcomlairVoice&&window.LibcomlairVoice.version==="v176"&&typeof window.LibcomlairVoice.speak==="function"&&typeof window.LibcomlairVoice.testDetailed==="function"),"moteur vocal Samsung-compatible"),
