(function(){
  ...
  function run(){
    ...
    const checks=[
      check("Voix",!!(voiceEngine&&voiceEngine.version==="v178"&&typeof voiceEngine.speak==="function"&&typeof voiceEngine.testDetailed==="function"&&!voiceHadRealFailure),voiceHadRealFailure?"dernier test vocal en échec":"moteur vocal multi-voix"),
